 ...
 */
export class TimePattern extends Component {
    static propTypes = {
    ...
    async componentDidMount() {
        if (this.props.start !== undefined && this.state.start === '') {
            let start = new Date('2023-01-01 ' + this.props.start);
        ...
        if (this.props.end !== undefined && this.state.end === '') {
            let end = new Date('2023-01-01 ' + this.props.end);
...
export default connect(mapStateToProps)(TimePattern)
