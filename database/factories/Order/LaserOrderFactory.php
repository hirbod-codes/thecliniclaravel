...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Order\LaserOrder>
 */
class LaserOrderFactory extends Factory
{
    ...
    public function setPriceWithDiscount(int $value): static
    {
        return $this->state(function (array $attributes) use ($value) {
            return ['price_with_discount' => $value];
        });
    }
